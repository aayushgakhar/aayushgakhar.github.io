...
`,a2=Zn`
  ...
  white-space: pre;
`,_0=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:o=1e3,fraction:i=0,keyframes:l=ws,triggerOnce:a=!1,css:u,className:s,style:d,childClassName:p,childStyle:h,children:g,onVisibilityChange:v}=e,w=O.exports.useMemo(()=>o2({keyframes:l,duration:o}),[o,l]);return i2(g)?null:l2(g)?se(u2,{...e,animationStyles:w,children:String(g)}):x0.exports.isFragment(g)?se(C0,{...e,animationStyles:w}):se(Qg,{children:O.exports.Children.map(g,(E,f)=>{if(!O.exports.isValidElement(E))return null;const c=[u,w],m=r+(t?f*o*n:0);switch(E.type){case"ol":case"ul":return se(ql,{children:({cx:y})=>se(E.type,{...E.props,className:y(s,E.props.className),style:{...d,...E.props.style},children:se(_0,{...e,children:E.props.children})})});case"li":return se(pf,{threshold:i,triggerOnce:a,onChange:v,children:({inView:y,ref:x})=>se(ql,{children:({cx:S})=>se(E.type,{...E.props,ref:x,className:S(p,E.props.className),css:y?c:gi,style:{...h,...E.props.style,animationDelay:m+"ms"}})})});default:return se(pf,{threshold:i,triggerOnce:a,onChange:v,children:({inView:y,ref:x})=>se("div",{ref:x,className:s,css:y?c:gi,style:{...d,animationDelay:m+"ms"},children:se(ql,{children:({cx:S})=>se(E.type,{...E.props,className:S(p,E.props.className),style:{...h,...E.props.style}})})})})}})})},u2=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:o=0,duration:i=1e3,fraction:l=0,triggerOnce:a=!1,css:u,className:s,style:d,children:p,onVisibilityChange:h}=e,{ref:g,inView:v}=k0({triggerOnce:a,threshold:l,onChange:h});return n?se("div",{ref:g,className:s,css:[u,a2],style:d,children:p.split("").map((w,E)=>se("span",{css:v?t:gi,style:{animationDelay:o+E*i*r+"ms"},children:w},E))}):se(C0,{...e,children:p})},C0=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,css:o,className:i,style:l,children:a,onVisibilityChange:u}=e,{ref:s,inView:d}=k0({triggerOnce:r,threshold:n,onChange:u});return se("div",{ref:s,className:i,css:d?[o,t]:gi,style:l,children:a})};C`
  from,
  20%,
  40%,
  60%,
...
`;const E2=[{name:"Retail Store",img:Iy,desc:"A retail store management system built with MySQL, Python and Tkinter.",link:"https://github.com/aayushgakhar/retail_store"},{name:"Will Hero",img:jy,desc:"A simple RPG game built with Java, using javafx for the frontend. Used OOPS and event driven programming. Developed in a team of 2.",link:"https://github.com/aayushgakhar/will-hero"},{name:"Simple RISC",img:Fy,desc:"A simple RISC machine simulator built with Java.",link:"https://github.com/aayushgakhar/Simple-risc-assembler-and-simulator"}],_2=()=>G("section",{className:"projects mx-auto",children:[P("div",{className:"pb-8",children:P("h2",{className:"hover-2 text-4xl font-bold inline",children:"Projects"})}),P("div",{className:"grid md:grid-cols-2 gap-4",children:P(P0,{cascade:!0,damping:.1,children:E2.map(e=>P(Ay,{project:e},e.name))})})]}),C2=({icon:e})=>(be.useRef(),P("div",{className:"opacity-100 scale-75 hover:scale-110 transition",children:P("img",{className:"w-20 mx-auto my-4 shadow-lg",src:e.icon,alt:e.name})})),P2=[{name:"python",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original-wordmark.svg"},{name:"java",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original-wordmark.svg"},{name:"c",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/c/c-original.svg"},{name:"c++",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cplusplus/cplusplus-original.svg"},{name:"sql",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg"},{name:"html",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original-wordmark.svg"},{name:"css",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original-wordmark.svg"},{name:"javascript",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg"},{name:"react",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original-wordmark.svg"},{name:"arduino",icon:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/arduino/arduino-original-wordmark.svg"}],O2=()=>G("section",{className:"skills mx-auto",children:[G("div",{className:"",children:[P("h2",{className:"hover-2 text-4xl font-bold inline",children:"Skills"}),P("p",{className:"py-4 text-gray-400",children:"These are the technologies I have worked with."})]}),P("div",{className:"w-full grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8",children:P(P0,{cascade:!0,damping:.01,children:P2.map(e=>P(C2,{icon:e},e.name))})})]});function T2(){return G("div",{className:"App",children:[P(Ry,{}),P(oy,{}),P(iy,{}),P(O2,{}),P(_2,{}),P(ly,{}),P(dy,{})]})}Jl.createRoot(document.getElementById("root")).render(P(be.StrictMode,{children:P(T2,{})}));
